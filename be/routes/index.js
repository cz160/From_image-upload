...
var storage = multer.diskStorage({
  ...
  filename: function (req, file, cb) {
    ...
    req.body.logo = '/uploads/' + _filename
    cb(null, _filename)
  }
})
...
// 已经是一个中间件了
var upload = multer({ storage, fileFilter }).single('logo') // .single处理单文件上层
...
/* GET home page. */
router.post('/api/upload', fileUpload, function(req, res, next) {
  res.set('content-type', 'text/plain')
  res.send('ok')
});
router.post('/api/test', fileUpload, function(req, res, next) {
